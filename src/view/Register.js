                ...
                <div className="signUp-container">
                    <div className="signUp-box">
                        ...
                        <div className="signUp-content">
                            ...
                            <br/>
                            <Input.Password size="large" placeholder="password" prefix={<LockOutlined />} onChange={this.password1Change}/>
                            <br/>
                            <Input.Password size="large" placeholder="password again" prefix={<LockOutlined />}onChange={this.password2Change}/>
                            <br/>
                            <Input size="large" placeholder="email" prefix={<MailOutlined />} onChange={this.emailChange}/>
                            <br/>
                            <div >
                            <Input size="large" style={{width:210}} placeholder="input verification code" prefix={<UserOutlined />} onChange={this.codeChange} />
                            <Button shape="round" size="large" class="signUp-btn" onClick={this.handlemailtest} >发送验证码</Button>
                            </div>
                            <br/>
                            <br/>
                            <Button shape="round" size="large"  onClick={this.handleCancel} >cancel</Button>
                            <Button type="primary" shape="round" size="large"  style={{float:"right"}} onClick={this.handleRegister}>confirm</Button>
