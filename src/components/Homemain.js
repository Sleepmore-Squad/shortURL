...
class Homemain extends React.Component {
    ...
    handleCreate()   //生成短连接
    {
        ...
        fetch('http://34.203.103.12:8181/order/count/' + userId + '/' + date, opts)
            .then((response) => {
            ...
            .then((data) => {
                if (data <= 9) {
                    ...
                    //返回最新的id
                    fetch('http://34.203.103.12:8181/url/getCount', opts1)
                        .then((response) => {
                            return response.json();
                        })
                        .then((data) => {
                            ...
                            fetch('http://34.203.103.12:8181/url/insert', opts2)
                                .then((response) => {
                                    //return response.json();
                                })
                        });
    ...
    render() {
        return (
            <div>
                ...
                <br/>
                <text>{"短链接：http://34.203.103.12:8181/to/" + this.state.shorturl}</text>
            </div>
        )
    }
}
